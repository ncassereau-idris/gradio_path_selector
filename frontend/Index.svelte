...
>
	...
	<div class="inodes">
		<div
			...
			>
				<svg
					...
					width="16" height="16" class="inode_icon">
		...
		{#each directories as directory, i}
			...
			>
				<svg
					aria-hidden="true" focusable="false" role="img" class="inode_icon"
					width="16" height="16" viewBox="0 2 16 16"
				>
		...
		{#each files as filename, i}
			...
			>
				<svg
					aria-hidden="true" focusable="false" role="img" class="inode_icon"
					viewBox="1 2 16 16" width="16" height="16">
